...
## Use Empty-RecycleBin.ps1 to permanently remove these from the recycling bin
Param(
  [string] $WebSite,
  [string] $ListName
  )
...
Write-Host "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
Write-Host "SharePoint Delete All Items Tool v2020.04.20.01       "
Write-Host "Created by Daikin Applied Americas, Web Dev Team      "
Write-Host "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
Write-Host

If ($WebSite.Length -eq 0 -or $ListName -eq 0) {
    Write-Host "Missing Parameters:"
    Write-Host "-WebSite (SharePoint Site)"
    Write-Host "-ListName (SharePoint List Name to remove items)"
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUijNZJ+1YnZaoKWHUX/rtyqDl
# 9VSgghMHMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# AQkEMRYEFMXSbsk56G1H2rDKvlOl79LuedQBMA0GCSqGSIb3DQEBAQUABIIBAMgt
# u+3tD+Qukbd/oym7ePGasoNae9DU6zSjB3Y0To6r/hHtHlKKyknvq4If5sMlcter
# 6vh/Dq7Myat8JBtFOhs592m8yGhYa9bay2udDCn07zw/SdI2VLkkMvq0Lmczo9ZJ
# zgpwIABFHDtRz/9zi1Icx61ZRxIMk4NN0OXmMDXju7ClRN0XtFX5szV8kZXC/9Yo
# X6AK1fIhBEemVI83edEhoxmO4cINkqQdEvNujKC1gWdqiZjyMbnF2yhLMiKH9ALp
# FI0zhYUumuRCezstzhiXyaApokbzs6Ll73FvgfSnBsJWiAb4ocI1g8fXMTQrFRrC
# KO+q7a30feDTiyt3wuOhggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEwaDBS
# MQswCQYDVQQGEwJCRTEZMBcGA1UEChMQR2xvYmFsU2lnbiBudi1zYTEoMCYGA1UE
...
# BgkqhkiG9w0BCQUxDxcNMjAwNDIwMjA1NjM2WjAjBgkqhkiG9w0BCQQxFgQUzYUj
# DgvBQFP6b9vksNeHCZvpCJ0wgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGEBBRj
...
# BIIBAGXeUqtP4z8dBJkZHthbHlZNJugePNzMuf8w8oGOqnlx78wGOHYFQ0NmwWdc
# ttza+H/eath/gI73FpvqbSVbegmzwkqBdsLdWYUTTLCWZ+0ucbtePSeLAaP0wk6y
# eEROXU0Idbt6tKHneoop5xcaNueqzQdoL6BNImLtL2lelpX3DhdFJHm1xvLNL6vx
# gsSpelIaz6hni2M/MpzgOI4ytqnPGREwDXPFo9ls+X1MaQVVW2haC6RmC6eCwhOv
# PGB/5L2Im1xaJu4WlCZNprQqw1oxG28VvHE8Ex0JctiYMCYp9yv1ihKkr27fVPYZ
# xo9DLk2JWYlS+2ZAC/gHTVtNvg4=
