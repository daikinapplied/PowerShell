Param (
    [string] $webSite,
    [string] $sites = "" # Optional quoted comma-separated list
)

Write-Host "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
Write-Host "SharePoint Empty RecycleBin Tool v2020.04.20.01         "
Write-Host "Developed by Daikin Applied Americas, Web Dev Team      "
Write-Host "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
Write-Host

If ($webSite.Length -eq 0) {
    Write-Host "Enter in the full URL to the SharePoint Site."
    Exit 1
}
...
If ($sites.Length -eq 0) {
    EmptyRecycleBin $webSite
}
Else {
    Foreach ($site in $sites.Split(",")) {
        $fullSitePath = $webSite + $site
        EmptyRecycleBin $fullSitePath
	}
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUq7MIibkYKmZ0wugcgpzd1vy7
# 7ZigghMHMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# AQkEMRYEFNFxx5xBPa1v1FZ/6s9kc4Tuqe8PMA0GCSqGSIb3DQEBAQUABIIBAGlw
# hah+zbriSIM4qCGRk/DFSD309uTQFRK/YT9BEKDfqQChpHJCcQLSntrgGQPv36BV
# WwFImJt1+m2Jz1dJJidkrB1qg63iC0ro5MEBIU6KiA7K+PB5oD9bqEziMN11af/a
# YKShJuGqN2kMHbsld9pmqbhiW4EYkq8sloPfb/7LF7S/d4S+J4q3eSCxS/LtrNYF
# Jr/NFExfA5l58YlkwBVQCQQP6aMVvXB7w8vgfHmwP2uyE8WOtzj+JWvxXvC0Ro9t
# unCvE7mYBkY3q+TloGLyujyE7QNwOK5kbhlHXBNyGSRgJOeIzPzfSygsaiGCKdq4
# T0ygEf7ZMTjn3Wo5PoShggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEwaDBS
# MQswCQYDVQQGEwJCRTEZMBcGA1UEChMQR2xvYmFsU2lnbiBudi1zYTEoMCYGA1UE
...
# BgkqhkiG9w0BCQUxDxcNMjAwNDIwMjEwNjQ5WjAjBgkqhkiG9w0BCQQxFgQUw2WT
# KuCK/BqIYh8acqru4+cuQmIwgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGEBBRj
...
# BIIBAIKRdDYAY8jKKusxGVtcdZfBeRrW4Qjng01XmRvAvQK4zGCy5d5EYP9XSgbN
# kZbXPoERYp3jU2/thG2iYv+MF64qCq79nZsfIlKy4LqyVBLHw/oWMWhOiLEZSz2C
# 0jo0HawwCj9jFzANKq88IolJqPPOdK1Boq+0ofM5lceI0j7D+EFGZelITns4joB3
# Iy1bCCh6/0b2vLcVP/omqaLQ9Epf0+EXzLW8mkMzApS5oYk2gPJaoLZqOuuk99Fg
# cC9MGrUilLPIl4/Eeswvnc7fMPazMscrbqvg5RPYCwDYnXrzfY/WnOThlpqtIzVz
# EM4bIP64DSbmVDXEQOxH17Kylds=
